...
class HopsworksSettings(BaseSettings):
    ...
    KEY_PARAMS_1: str | None = None
    KEY_PARAMS_2: str | None = None
    ...
    def model_post_init(self, __context):
        ...
        # 3. KEY_PARAMS_1
        key_params_1 = self.KEY_PARAMS_1 or os.getenv("KEY_PARAMS_1")
        if not key_params_1:
            missing.append("KEY_PARAMS_1")
        # 4. KEY_PARAMS_2
        key_params_2 = self.KEY_PARAMS_2 or os.getenv("KEY_PARAMS_2")
        if not key_params_2:
            missing.append("KEY_PARAMS_2")
        # 5. AQICN_STREET
        key_params_3 = self.KEY_PARAMS_3 or os.getenv("KEY_PARAMS_3")
        if not key_params_3:
            missing.append("KEY_PARAMS_3")
        # 6. AQICN_URL
        key_params_4 = self.KEY_PARAMS_4 or os.getenv("KEY_PARAMS_4")
        if not key_params_4:
            missing.append("KEY_PARAMS_4")
